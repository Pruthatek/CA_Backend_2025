...
class Inquiry(models.Model):
    ...
    reference_email_id = models.EmailField(max_length=100, blank=True, null=True)
    ...
    call_email_id = models.EmailField(max_length=100, blank=True, null=True)
    ...
    otp_email_id = models.EmailField(max_length=100, blank=True, null=True)
