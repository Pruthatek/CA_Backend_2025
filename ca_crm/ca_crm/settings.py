"""
Django settings for ca_crm project.
...
ALLOWED_HOSTS = ["127.0.0.1", "localhost", "erp.vatsalsharma.com", "erpapi.vatsalsharma.com" ]
...
ROOT_URLCONF = 'ca_crm.urls'

REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'custom_auth.authentication.JWTAuthentication',  # Replace 'yourapp' with your actual app name
    ],
...
WSGI_APPLICATION = 'ca_crm.wsgi.application'
